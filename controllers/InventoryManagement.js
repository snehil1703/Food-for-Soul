...
// this function uploads classnotes on the server and calls model method to insert classnotes details into the database.
exports.uploadClassNotes= (req, res) => {
  ...
  sampleFile = req.files.sellerfile;
  // the classnotes are stored in the classnotes folder in the server file system
...
// This function sends form page to add new classnotes details
...
// This function sends form page to add new classnotes details
exports.getUploadClassNotesPage = (req, res) => {
